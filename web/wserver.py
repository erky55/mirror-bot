...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/erky55/mirror-bot"><i class="fab fa-github"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See mirror-leech-switch-bot <a href='https://github.com/erky55/mirror-bot'>@GitHub</a></h1>"
